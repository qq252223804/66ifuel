...
#   调用必须消费者端进行配置响应超时时间 如果开发那边没写消费端是调不通的
...
if __name__ == '__main__':
    url = 'http://192.168.3.142:20983/'
    interface = 'com.ifuel.cec.manager.client.service.PartnersService'
    method = 'deletePartners'
    param_obj = 'package com.ifuel.cec.manager.client.domain.PartnersDTO'
    params = {"partnersId": 29}
